...
"""
    ...
    with open('/opt/Raider/raider/danger/version', 'r') as file:
        current_version = file.read()
        print('[!] Version: ', end='')
        printc(current_version, GREEN)
        current_version = current_version.replace('.', '')
    
    online_version_url = 'https://raw.githubusercontent.com/TREASURE404DANGER/Raider/main/raider/danger/version'
    ...
    if online_version > current_version:
        printc('[*] A New version of RAIDER is available.', GREEN)
        ...
        if (answer.upper() == 'Y'):
            cmd = 'curl https://raw.githubusercontent.com/TREASURE404DANGER/Raider/main/install.sh|bash'
            ...
            try:
                ...
                if output:
                    ...
                    print('[!] Exiting now. Launch RAIDER again to load the new verison.')
                    print('[!] BYE!!!')
                    sys.exit(0)
